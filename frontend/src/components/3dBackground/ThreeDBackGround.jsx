...
import { Outlines, Environment, useTexture, Float } from "@react-three/drei"
import { Physics, useSphere } from "@react-three/cannon"
import { EffectComposer, N8AO, SMAA } from "@react-three/postprocessing"
import Sass from '../../assets/sass_texture_ball.jpg'
...
function Clump({ mat = new THREE.Matrix4(), vec = new THREE.Vector3(), ...props }) {
  const [ref, api] = useSphere(() => ({ args: [1], mass: 5, angularDamping: 0.7, linearDamping: 0.65, position: [rfs(20), rfs(10), rfs(20)] }))
